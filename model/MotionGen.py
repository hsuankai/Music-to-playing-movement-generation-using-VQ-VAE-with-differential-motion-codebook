...
from .diffsound.encdec import Encoder1d, Decoder1d
...
class MotionVQVAE(L.LightningModule):
    def __init__(self,  args):
        ...
        self.encoder = Encoder1d(args.in_channels, args.emb_dim, args.ch)
        self.decoder = Decoder1d(args.in_channels, args.emb_dim, args.ch)
        self.bottleneck = nn.ParameterList([BottleneckBlock(args.codebook_size[i], args.emb_dim, 0.99) for i in range(args.codebook_num)])
